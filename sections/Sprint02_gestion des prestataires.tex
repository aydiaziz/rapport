...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\linewidth]{figures/Inscription d’un prestataire.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\linewidth]{figures/Compléter le profil helper.png}
...
\subsection*{Exprimer son intérêt pour un ordre de mission}
\begin{figure}[H]
\centering
...
\begin{figure}[H]
\centering
\includegraphics[width=0.65\linewidth]{figures/Processus de complétion de profil prestataire.png}
